Feature: USDTINR Regression

  @PlaceGetDeleteOrder @Regression @USDT
  ...
  @CancelAllOrder @Regression @USDT
  ...
  @GetBalanceforDifferentBroker @Regression @USDT
  Scenario: Verify funds for diffrent broker in fulfilled case
    ...
    Given take balance of "USDT" with api "Getbalance" with name "s1b2btc"
    ...
    Given take balance of "USDT" with api "Getbalance" with name "s2b2btc"
    Given Placing an order for broker "B2" of type "limit" side "SELL" instrument "USDT/INR" quantityType "QUOTE" quantity "10000" limitPrice "3500000" username "user1"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    And Verify key "message" of response "Order placed successfully"
    And Verify the "data.orderID" of response "GetOrder"
    ...
    Given take balance of "USDT" with api "Getbalance" with name "s3b2btc"
  ...
  Scenario: Verify funds for diffrent broker in partially fulfilled case
    ...
    Given take balance of "INR" with api "Getbalance" with name "s2b2inr"
    Given take balance of "USDT" with api "Getbalance" with name "s2b2btc"
    Given Placing an order for broker "B2" of type "limit" side "SELL" instrument "USDT/INR" quantityType "QUOTE" quantity "5000" limitPrice "3500000" username "user1"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    And Verify key "message" of response "Order placed successfully"
    And Verify the "data.orderID" of response "GetOrder"
  ...
  Scenario: Verify funds for diffrent broker in cancelled case
    ...
    Given take balance of "INR" with api "Getbalance" with name "s2b2inr"
    Given take balance of "USDT" with api "Getbalance" with name "s2b2btc"
    Given Placing an order for broker "B2" of type "limit" side "SELL" instrument "USDT/INR" quantityType "QUOTE" quantity "10000" limitPrice "3600000" username "user1"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    And Verify key "message" of response "Order placed successfully"
    And Verify the "data.orderID" of response "GetOrder"
  ...
  Scenario: Verify funds for diffrent broker in price improvement case
    ...
    Given take balance of "INR" with api "Getbalance" with name "s2b2inr"
    Given take balance of "USDT" with api "Getbalance" with name "s2b2btc"
    Given Placing an order for broker "B2" of type "limit" side "SELL" instrument "USDT/INR" quantityType "QUOTE" quantity "5000" limitPrice "1750000" username "user1"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    And Verify key "message" of response "Order placed successfully"
    And Verify the "data.orderID" of response "GetOrder"
  ...
  @GetBalanceforSameBroker1 @Regression @USDT
  ...
  @GetBalanceforSameBroker2 @Regression @USDT
  ...
  @GetBalanceforSameBroker3 @Regression @USDT
  ...
  @GetBalanceforSameBroker4 @Regression @USDT
  ...
  @GetBalanceforSameBroker5 @Regression @USDT
  ...
  @BUYSELLBUYorders @Regression @USDT
  Scenario: Verify funds for same broker in BUYSELLBUY fulfilled case
    Given loading the header for broker "B1"
    Given take balance of "INR" with api "Getbalance" with name "s1b1inr"
    Given take balance of "USDT" with api "Getbalance" with name "s1b1btc"
    Given Placing an order for broker "B1" of type "limit" side "BUY" instrument "USDT/INR" quantityType "quote" quantity "5000.06" limitPrice "49" username "user1"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    And Verify key "message" of response "Order placed successfully"
    And Verify the "data.orderID" of response "GetOrder"
    ...
    Given take balance of "USDT" with api "Getbalance" with name "s2b1btc"
    #placing 2nd order for matching
    Given Placing an order for broker "B1" of type "limit" side "SELL" instrument "USDT/INR" quantityType "quote" quantity "10000.12" limitPrice "49" username "user"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    Then give sleep of "2000"
    And Verify key "message" of response "Order placed successfully"
    ...
    Given Placing an order for broker "B1" of type "limit" side "BUY" instrument "USDT/INR" quantityType "quote" quantity "5000.06" limitPrice "49" username "user2"
    When Providing request PathUrl "PlaceOrder" with method "POST"
    Then I verify the  "200" in step
    And Verify key "message" of response "Order placed successfully"
    And Verify the "data.orderID" of response "GetOrder"
